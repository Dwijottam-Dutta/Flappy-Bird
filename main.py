...
BACKGROUND = './gallery/background4.jpg'
BACKGROUND_SECOND = './gallery/background2.jpg'
BACKGROUND_THIRD = './gallery/background5.jpg'
BACKGROUND_FOUR = './gallery/background3.jpg'
BACKGROUND_FIVE = './gallery/background7.jpg'
    ...
    while True:
        ...
        for pipe in upperPipes:
            ...
            if pipeMidPos <= playerMidPos < pipeMidPos + 4:
                ...
                w.write("~ ~ ~ ~ ~ WELCOME to Flappy Bird+ (Reality) Professional Edition ~ ~ ~ ~ ~\n")
                w.write("   \n")
...
if __name__ == "__main__":
    ...
    GAME_SOUNDS['Yay2'] = pygame.mixer.Sound('./gallery/hello_startup2.mp3')
    GAME_SOUNDS['hello2'] = pygame.mixer.Sound('./gallery/hello_game2.mp3')
    GAME_SOUNDS['hello3'] = pygame.mixer.Sound('./gallery/hello_game3.mp3')
    GAME_SOUNDS['hello4'] = pygame.mixer.Sound('./gallery/hello_game4.mp3')
