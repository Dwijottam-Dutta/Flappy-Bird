...
def mainGame():
    ...
    playerFlapAccv = -7  # velocity while flapping
...
if __name__ == "__main__":
    ...
    GAME_SOUNDS['hit'] = pygame.mixer.Sound('./gallery/areyousure.wav')
    GAME_SOUNDS['hitt'] = pygame.mixer.Sound('./gallery/hit.wav')
